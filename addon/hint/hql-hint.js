      ...
      if (token[token.length - 1] === ".") {
        ...
        if (block.counter === 0) {
          ...
          return this._addHints(ctx, {
            ...
            add: ["distinct", "new", "*"].concat(this.collectionAgregate, this.collectionQualifiedPath, this.collectionFunctions, this.collectionType)
          });
          ...
          return this._addHints(ctx, [")"]);
        } else if (token === "distinct" || token === "new") {
          return this._addHints(ctx, []);
        } else if (token === ",") {
          block.canAddExtract = true;
          return this._addHints(ctx, {
